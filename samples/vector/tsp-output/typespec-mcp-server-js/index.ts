...
import { addVectorParameters, addVectorReturnType, crossProductParameters, crossProductReturnType, dotProductParameters, dotProductReturnType, subVectorParameters, subVectorReturnType } from "./zod-types.js";
  ...
  async function callTool(request) {
    ...
    switch (name) {
      case "addVector": {
        ...
        const rawResult = await toolHandler.math_add_vector(
          parsed.data.v1,
          parsed.data.v2
        );
      ...
      case "subVector": {
        ...
        const rawResult = await toolHandler.math_sub_vector(
          parsed.data.v1,
          parsed.data.v2
        );
      ...
      case "crossProduct": {
        ...
        const rawResult = await toolHandler.math_cross_product(
          parsed.data.v1,
          parsed.data.v2
        );
      ...
      case "dotProduct": {
        ...
        const rawResult = await toolHandler.math_dot_product(
          parsed.data.v1,
          parsed.data.v2
        );
