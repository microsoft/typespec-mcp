...
export interface Tools {
   ...
   */
  mathAddVector(v1: Vec3, v2: Vec3): Vec3 | Promise<Vec3>
   ...
   * point to another.
   */
  mathSubVector(v1: Vec3, v2: Vec3): Vec3 | Promise<Vec3>
   ...
   */
  mathCrossProduct(v1: Vec3, v2: Vec3): Vec3 | Promise<Vec3>
   ...
   */
  mathDotProduct(v1: Vec3, v2: Vec3): number | Promise<number>
}
