...
export function decodeBase64(value: string): Uint8Array | undefined {
  ...
  if(!input_) {
    ...
    return {
    id: input_.id,node_id: input_.nodeId,url: input_.url,forks_url: input_.forksUrl,commits_url: input_.commitsUrl,git_pull_url: input_.gitPullUrl,git_push_url: input_.gitPushUrl,html_url: input_.htmlUrl,comments_url: input_.commentsUrl,public: input_.public_,description: input_.description,comments: input_.comments,user: jsonUserToTransportTransform(input_.user),files: jsonRecordGistFileToTransportTransform(input_.files),created_at: input_.createdAt,updated_at: input_.updatedAt,owner: jsonUserToTransportTransform(input_.owner),comments_enabled: input_.commentsEnabled,truncated: input_.truncated
  }!;
  ...
  if(!input_) {
    ...
    return {
    id: input_.id,nodeId: input_.node_id,url: input_.url,forksUrl: input_.forks_url,commitsUrl: input_.commits_url,gitPullUrl: input_.git_pull_url,gitPushUrl: input_.git_push_url,htmlUrl: input_.html_url,commentsUrl: input_.comments_url,public_: input_.public,description: input_.description,comments: input_.comments,user: jsonUserToApplicationTransform(input_.user),files: jsonRecordGistFileToApplicationTransform(input_.files),createdAt: input_.created_at,updatedAt: input_.updated_at,owner: jsonUserToApplicationTransform(input_.owner),commentsEnabled: input_.comments_enabled,truncated: input_.truncated
  }!;
  ...
  if(!input_) {
    ...
    return {
    url: input_.url,version: input_.version,user: jsonUserToTransportTransform(input_.user),change_status: jsonChangeStatusToTransportTransform(input_.changeStatus),committed_at: input_.committedAt
  }!;
  ...
  if(!input_) {
    ...
    return {
    url: input_.url,version: input_.version,user: jsonUserToApplicationTransform(input_.user),changeStatus: jsonChangeStatusToApplicationTransform(input_.change_status),committedAt: input_.committed_at
  }!;
