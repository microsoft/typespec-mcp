namespace Mcp
{
    public interface IGists
    {
        ...
        /// </summary>
        ///
        public Task<Gist[]> ListPublicAsync(
            DateTimeOffset? since, CancellationToken cancellationToken = default
        );
        ...
        /// </summary>
        ///
        public Task<Gist[]> ListStarredAsync(
            DateTimeOffset? since, CancellationToken cancellationToken = default
        );
        ...
        /// </summary>
        ///
        public Task<GistCommit[]> ListCommitsAsync(
            string id, CancellationToken cancellationToken = default
        );
        ...
        /// </summary>
        ///
        public Task<Gist[]> ListForksAsync(
            string id, CancellationToken cancellationToken = default
        );
        ...
        /// </summary>
        ///
        public Task<bool> IsStarredAsync(
            string id, CancellationToken cancellationToken = default
        );
    }
}