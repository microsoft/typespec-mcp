namespace Mcp
{
    ...
    public class GistsHandler
    {
        ...
        public async Task<Gist> CreateAsync(CreateGist gist, CancellationToken cancellationToken)
        {
        ...
        public async Task<Gist[]> ListPublicAsync(DateTimeOffset since, CancellationToken cancellationToken)
        {
        ...
        public async Task<Gist[]> ListStarredAsync(DateTimeOffset since, CancellationToken cancellationToken)
        {
            return await this.impl.ListStarredAsync(since, cancellationToken);
        }

        [McpServerTool(Name = "gists_get"), Description(@"Get a gist")]
        public async Task<Gist> GetAsync(string id, CancellationToken cancellationToken)
        {
            return await this.impl.GetAsync(id, cancellationToken);
        }

        [McpServerTool(Name = "gists_update"), Description(@"Update a gist")]
        public async Task<Gist> UpdateAsync(string id, CreateGist gist, CancellationToken cancellationToken)
        {
            return await this.impl.UpdateAsync(id, gist, cancellationToken);
        }

        [McpServerTool(Name = "gists_delete"), Description(@"Delete a gist")]
        public async Task<Task> DeleteAsync(string id, CancellationToken cancellationToken)
        {
            return await this.impl.DeleteAsync(id, cancellationToken);
        }

        [McpServerTool(Name = "gists_fork"), Description(@"List gist commitsList gist forksFork a gist")]
        public async Task<Gist> ForkAsync(string id, CancellationToken cancellationToken)
        {
            return await this.impl.ForkAsync(id, cancellationToken);
        }

        [McpServerTool(Name = "gists_star"), Description(@"Star a gist")]
        public async Task<Task> StarAsync(string id, CancellationToken cancellationToken)
        {
            return await this.impl.StarAsync(id, cancellationToken);
        }

        [McpServerTool(Name = "gists_unstar"), Description(@"Unstar a gist")]
        public async Task<Task> UnstarAsync(string id, CancellationToken cancellationToken)
        {
