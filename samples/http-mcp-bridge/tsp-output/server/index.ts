...
const tools = {
  ...
  gists_list: "list",
  gists_create: "create",
  gists_list_public: "listPublic",
  gists_list_starred: "listStarred",
  gists_get: "get",
  gists_update: "update",
  gists_delete: "delete_",
  gists_list_commits: "listCommits",
  gists_list_forks: "listForks",
  gists_fork: "fork",
  gists_star: "star",
  gists_unstar: "unstar",
  gists_is_starred: "isStarred",
} as const;
