namespace Mcp
{
    ...
    public class MathHandler
    {
        ...
        public async Task<Vec3> AddVectorAsync(
            Vec3 v1, Vec3 v2, CancellationToken cancellationToken = default
        )
        {
        ...
        point to another.")]
        public async Task<Vec3> SubVectorAsync(
            Vec3 v1, Vec3 v2, CancellationToken cancellationToken = default
        )
        {
        ...
        public async Task<Vec3> CrossProductAsync(
            Vec3 v1, Vec3 v2, CancellationToken cancellationToken = default
        )
        {
        ...
        public async Task<double> DotProductAsync(
            Vec3 v1, Vec3 v2, CancellationToken cancellationToken = default
        )
        {
